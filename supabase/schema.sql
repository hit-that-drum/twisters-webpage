...
ALTER TABLE test_board ADD COLUMN IF NOT EXISTS "imageUrl" TEXT[] NOT NULL DEFAULT ARRAY[]::TEXT[];
...
ALTER TABLE board ADD COLUMN IF NOT EXISTS "imageUrl" TEXT[] NOT NULL DEFAULT ARRAY[]::TEXT[];
